...
<%
 /**
  * @Class Name : DocumentRegister.jsp
  * @Description : Document Register 화면
...
<c:set var="registerFlag" value="${empty documentVO.id ? '등록' : '수정'}"/>			
...
<!-- validator:javascript formName="documentVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/document/DocumentList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/document/deleteDocument.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/document/addDocument.do' : '/document/updateDocument.do'}"/>";
    frm.submit();
...
<form:form commandName="documentVO" name="detailForm" id="detailForm" >
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" >
		...
		<tr>
			<th>time</th>
			<td>
				<form:input path="time" cssClass="txt"/>
		...
		<tr>
			<th>level</th>
			<td>
				<form:input path="level" cssClass="txt"/>
		...
		<tr>
			<th>star</th>
			<td>
				<form:input path="star" cssClass="txt"/>
